        ...
        if prescription_id:
            ...
            if prescription:
                ...
                if 'pharmacist_initials' in prescription._fields:
                    res['pharmacist_initials'] = prescription.pharmacist_initials or ''
        return res
        ...
        for wizard in self:
            ...
            if 'pharmacy.dispensing.log' in self.env:
                ...
                if 'pharmacist_initials' in Log._fields:
                    vals['pharmacist_initials'] = wizard.pharmacist_initials or ''
                if 'notes' in Log._fields:
                    vals['notes'] = wizard.notes or 'Prescription dispensed from confirmation popup.'
                if 'dispense_date' in Log._fields:
                    vals['dispense_date'] = fields.Datetime.now()
            ...
            if 'pharmacist_initials' in prescription._fields:
                prescription.sudo().write({'pharmacist_initials': wizard.pharmacist_initials or ''})
