...
class PharmacyProductTemplateWebsiteMarketingFields(models.Model):
    _inherit = 'product.template'

    hot_deals = fields.Boolean(
        string='Hot Deals',
        help='Mark this product as a hot deal for website/e-commerce promotions.'
    )
    featured_product = fields.Boolean(
        string='Featured Product',
        help='Mark this product as featured for website/e-commerce promotions.'
    )
    new_arrival = fields.Boolean(
        string='New Arrival',
        help='Mark this product as a new arrival.'
    )
    best_seller = fields.Boolean(
        string='Best Seller',
        help='Mark this product as a best seller.'
    )
    promo_label = fields.Char(
        string='Promotion Label',
        help='Optional website promotion label, e.g. Sale, Hot Deal, New.'
    )
