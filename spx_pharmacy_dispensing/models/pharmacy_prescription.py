...
class PharmacyPrescription(models.Model):
    ...
    def action_view_alerts(self):
        return {'type':'ir.actions.act_window','name':'Safety Alerts','res_model':'pharmacy.safety.alert','view_mode':'tree,form','domain':[('prescription_id','=',self.id)]}

    def action_view_dispensing(self):
        return {'type':'ir.actions.act_window','name':'Dispensing Logs','res_model':'pharmacy.dispensing.log','view_mode':'tree,form','domain':[('prescription_id','=',self.id)]}
